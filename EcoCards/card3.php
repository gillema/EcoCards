...
<head>
    ...
    <title>Card Vento - Project EcoCards</title>
...
<body>
    ...
    <main class="main-content" id="mainContent">
        <h1>Card Ecológico: O Vento</h1>
        
        <div class="card-detail-container">
            <div class="card-detail-image">
                <img src="imagens/vento.png" alt="Card Vento">
            </div>
            
            <div class="card-detail-content">
                <h2>Agente de Movimento</h2>
                <p>O Vento no jogo EcoCards representa a força que dispersa sementes, poliniza plantas e influencia o clima.</p>
                
                <h3>Mecânica de Jogo:</h3>
                <ul>
                    <li><strong>Dispersão:</strong> Pode mover cartas de semente ou pólen entre zonas do jogo.</li>
                    <li><strong>Efeito Climático:</strong> Modifica o poder de certas cartas de planta e animal.</li>
                    <li><strong>Combinações:</strong> Quando combinado com cartas de Montanha, pode criar efeitos de chuva.</li>
                </ul>
                
                <h3>Impacto Ecológico:</h3>
                <p>Este card ilustra o papel do vento na dispersão de espécies e na regulação dos ecossistemas, mostrando como fatores abióticos afetam a vida.</p>
                
                <div class="card-stats">
                    <div class="stat">
                        <span class="stat-label">Raridade</span>
                        <span class="stat-value">Incomum</span>
                    </div>
                    <div class="stat">
                        <span class="stat-label">Tipo</span>
                        <span class="stat-value">Recurso/Clima</span>
                    </div>
                    <div class="stat">
                        <span class="stat-label">Poder</span>
                        <span class="stat-value">Variável</span>
                    </div>
                </div>
