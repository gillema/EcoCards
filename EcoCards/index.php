...
<body>
    ...
    <main class="main-content" id="mainContent">
        ...
        <p>Clique no ícone de usuário na barra de navegação para abrir o menu.</p>
        

        <div class="card-container">
            <a href="card1.php" class="card">
                <img src="imagens/aguabg.png" alt="Produto 1" class="card-image">
            ...
            <a href="card2.php" class="card">
                <img src="imagens/solbg.png" alt="Produto 2" class="card-image-sol">
                <div class="card-content">
            ...
            <a href="card3.php" class="card">
                <img src="imagens/ventobg.png" alt="Produto 3" class="card-image-vento">
                <div class="card-content">
